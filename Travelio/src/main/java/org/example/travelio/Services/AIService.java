...
public class AIService {
    ...
    public Map generatePlan(AIRequest dto) {
        ...
        Map<String, Object> body = getStringObjectMap(dto, interestsStr);
    ...
    private static @NonNull Map<String, Object> getStringObjectMap(AIRequest dto, String interestsStr) {
        String prompt = """
